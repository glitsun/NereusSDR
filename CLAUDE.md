...
### Current Phase: v0.2.3 shipped 2026-04-24 — RX epic + Alex antennas complete. **3M-1 SSB TX shipped via PR #152 (2026-04-29).** **3M-3a-i (TX EQ + Leveler + ALC) Complete (pending bench) on `feature/phase3m-3-tx-processing` 2026-04-29 — 13 GPG-signed commits across 6 batches; 246/246 tests green; awaiting JJ bench on ANAN-G2.** Next sub-PR is **3M-3a-ii (CFC + CESSB + Pre-emphasis)** on the same epic; 3M-2 CW TX deferred until after the full 3M-3 epic ships AND the HL2 ATT/filter safety audit closes (HL2 TX bench was deferred during 3M-1c after JJ flagged ATT/filter code paths that could damage the radio if engaged — see PR #152 rows 58-60).
...
| 3M-3a-ii: CFC + CESSB + Pre-emphasis | CFC (Continuous Frequency Compressor) + CESSB (Controlled-Envelope SSB) + Pre-emphasis (FM-mode) WDSP wrappers + setup pages + TxApplet wiring. Picks up the [PROC] quick-toggle wired in 3M-3a-i Batch 2. | **Next** |
